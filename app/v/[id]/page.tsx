...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://memekabgsmp.pages.dev/v/${file.filecode}#${file.title}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://memekabgsmp.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://memekabgsmp.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://memekabgsmp.pages.dev/v/${file.filecode}#${file.title}`
            }  
        }
        }
